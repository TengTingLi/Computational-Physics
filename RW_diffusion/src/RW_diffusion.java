 ...
 * @date 7-6-2023
 */
public class RW_diffusion extends javax.swing.JFrame {
...
// </editor-fold>
    ...
    public void theory(double D){
        double rho, sigma, t = 0, x;
        for(t = 0; t < 10; t += 2){
            sigma = Math.sqrt(2*D*t);
           for(x = -20; x < 20; x+=0.2){
               rho = (1/sigma)*Math.exp(-(x*x)/(2*sigma*sigma));
               plot_point(x,rho);
    ...
    public void calculate(double D){
        double del_t = 0.10, del_x = 0.5;
        double rho[][] = new double[1000][1000];
        ...
        for(n = 0; n < 10; n++){
            ...
            for(i = 1; i < 500; i++){
                rho[i][n+1] = rho[i][n] 
                              + (D * del_t / (del_x * del_x)) * (rho[i+1][n] + rho[i-1][n] - 2 * rho[i][n]);
                x[i+1] = x[i] + del_x;
                plot_point(x[i],rho[i][n]);
                plot_point(-x[i],rho[i][n]);
                
            }
            try{Thread.sleep(100);}catch(Exception ee){System.out.println("what");}
            
            System.out.println("1 "+n);
        }
        //lable_number.setText("done");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RW_diffusion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RW_diffusion().setVisible(true);
            }
        });
    }
