...
public class random_number extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panel_plot.setBackground(new java.awt.Color(255, 204, 204));
...
// </editor-fold>
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        init_plot(0,0,11,11,8,94,panel_plot);
        set_pen_size(2);
        for(int i = 0; i < 1000; i++){
            try {
                Thread.sleep(2);
            } catch (InterruptedException ex) {
                Logger.getLogger(random_number.class.getName()).log(Level.SEVERE, null, ex);
            }
            double x1 = 1.0;
            double x2 = 10.0;
            ...
            double y = x1*(1.0 - f) + x2*f;
            tf_output.append(x+" "+y+"\n");
            plot_point(x,y);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(random_number.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
